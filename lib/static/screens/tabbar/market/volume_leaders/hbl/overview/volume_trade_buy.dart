...
class VolumeTradeBuy extends StatefulWidget {
  @override
  _VolumeTradeBuyState createState() => _VolumeTradeBuyState();
}

class _VolumeTradeBuyState extends State<VolumeTradeBuy> {
